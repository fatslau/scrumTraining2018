...
public class ParkingLotTest {
    ...
    * */
     ...
     * */
    @Test
    public void testRentalFailNoSpace(){
     ...
     * when: customer request to get back his car and give us his car#
     * then: cannot find his car
     * */
    @Test
    public void testCanPickUpFail(){
        ParkingLot parking = new ParkingLot(0);
        Car car1 = new Car("A");
        Car car2 = new Car("B");
    ...
    public void testPickUp(){
        ...
        Car car = new Car("PV5080");
        parking.parkCar(car);
        assertTrue(parking.pickCar(car));
    }
     ...
     * */
    @Test
    public void testPickUpFailNoRental(){
        ParkingLot parking = new ParkingLot(1);
        Car car1 = new Car("A");
        Car car2 = new Car("B");
        parking.parkCar(car1);
        assertFalse(parking.pickCar(car2));
        assertEquals(0,parking.getAvailability());
    }
}
